...
Visualization for Matsim network files. In case network file is based on OpenStreetMap data it is hard to visually browse nodes streets and etc. The project
aims to improve this experience
